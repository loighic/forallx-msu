...
\noindent This is not a perfect definition. \textit{Form} in formal logic is much broader than just the use of those ``structure words.'' This is a good definition with which to start, however.
