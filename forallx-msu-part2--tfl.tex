...
And we will use this symbolization key:
	...
	\end{ekey}
Sentence \ref{if1} has this form: `if P, then F', and any sentence with this form is called a \define{conditional}. We will use `\eif' to symbolize `if \ldots, then \ldots'. Thus, sentence \ref{if1} becomes `$(P\eif F)$'. 
