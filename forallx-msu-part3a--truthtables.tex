...
\end{earg}
We worked that out by thinking about the different possible scenarios, and the logic of `or' and `and'. An alternative, and a somewhat easier method to use for more complex sentences, is to create a truth table. Truth tables tell us when a sentence is true or false, and, as we will see in chapters \ref{s:SemanticConcepts} and \ref{c:tt-validity}, they allow us to perform other analyses as well. 
