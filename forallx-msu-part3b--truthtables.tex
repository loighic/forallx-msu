...
Next is this important observation: if $\meta{A}_1, \meta{A}_2, \ldots, \meta{A}_n$ entail $\meta{C}$, then $\meta{A}_1, \meta{A}_2, \ldots, \meta{A}_n \therefore \meta{C}$ is valid.
...
T& F& F &   T &\TTbf{T}& F   &   T &\TTbf{F}& F   &   F& \TTbf{T}& T& F &\checkmark  & \TTbf{F}\\\arrayrulecolor{light-gray}\hline
F& T& T &   F &\TTbf{T}& T   &   F &\TTbf{T}& T   &   T& \TTbf{F}& F& T&\checkmark   & \TTbf{T}\Tstrut\\ 
...
T & T & F & F &  &  &   		&\checkmark	& T & &  \TTbf{T} &\\\arrayrulecolor{light-gray}\hline
T & F & T & T &  &  &  		&\checkmark	& & &  \TTbf{T} &\Tstrut\\
T & F & T & F & ? & ? & ?  	&?	& F &  &  \circled{\TTbf{F}} &\\
T & F & F & T & & & 			&\checkmark	& & & \TTbf{T} &\\
T & F & F & F & & & 			&\checkmark	& T &  & \TTbf{T} & \\\arrayrulecolor{light-gray}\hline
F & T & T & T & & & 			&\checkmark	& & & \TTbf{T} & \Tstrut\\
F & T & T & F & ? & ? & ? 	&?	& F &  & \circled{\TTbf{F}} &\\
F & T & F & T & & &  			&\checkmark	& & & \TTbf{T} & \\
F & T & F & F & & & 			&\checkmark	&T & & \TTbf{T} & \\\arrayrulecolor{light-gray}\hline
F & F & T & T & & & 			&\checkmark	& & & \TTbf{T} & \Tstrut\\
