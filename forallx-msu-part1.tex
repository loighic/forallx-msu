...
\begin{earg}
\item A valid argument that has one false premise and one true premise
\item[] \myanswer{Yes, this is possible.\\ `All whales are mammals (\emph{true}).  All mammals are plants (\emph{false}). Therefore, all whales are plants.' }\smallskip
\item A valid argument that has a false conclusion
\item[] \myanswer{Yes, this is possible. See example from previous exercise.}\smallskip
\item A valid argument, the conclusion of which is a necessary falsehood
\item[] \myanswer{Yes, this is possible. `$1+1=3$. Therefore, $1+2=4$.'}\smallskip
\item An invalid argument, the conclusion of which is a necessary truth
