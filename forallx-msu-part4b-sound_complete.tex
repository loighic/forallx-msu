...
\begin{notebox}
\textit{Soundness}, the property of logical systems that we are discussing here, is different than the \textit{sound}, the property of individual arguments, that is defined on p.~\pageref{def-sound-arg}.
\end{notebox}
