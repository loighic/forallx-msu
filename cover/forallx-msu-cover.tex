...
%\documentclass[bleedwidth=6.35mm, marklength=0mm, coverheight=228.6mm, coverwidth=152.4mm, spinewidth=12.3mm]{bookcover} %Amazon

\documentclass[bleedwidth=3.17mm, marklength=0mm, coverheight=228.6mm, coverwidth=152.4mm, spinewidth=13.82mm]{bookcover} %Lulu
...
% For Lulu, just change the spinewidth, which will be provided once the pdf is uploaded.

\usepackage{GS1,qrcode}   % for the barcode
%\usepackage[cmyk]{xcolor}

%\definecolor{forallx-orange}{RGB}{254, 102, 1}
%\definecolor{forallx-orange}{cmyk}{0, 60, 100, 0}
\definecolor{forallx-orange}{HTML}{FE6601}
...
%\savebox0{\EANBarcode[module_height=12mm]{ISBN 9798865977643}} %Amazon
\savebox0{\EANBarcode[module_height=12mm]{ISBN 9781716848377}} %Lulu
\colorbox{white}{%
\usebox0
