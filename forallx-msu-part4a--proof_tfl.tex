...
\item[\ex{14.6.5}] And last, a proof for $$(S \eif T) \eor R, (T \eif S) \eor Q, \enot R \eand \enot Q \proves T \eiff S$$ requires the conjunction elimination rule, the disjunction elimination rule, and the biconditional introduction rule ($\eiff$ex).
\begin{proof}
...
\begin{proof}
	...
	\have{con2}{S \eiff (T \eor S)} \bex{con1}
\end{proof}
\medskip
...
\have{con}{J \eiff [J\eor (L \eand \enot L)]}\bex{conj}
\end{proof}}
\bigskip
